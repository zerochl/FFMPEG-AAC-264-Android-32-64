...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=./android/x86_64-vfp --enable-cross-compile --disable-runtime-cpudetect --disable-asm --arch=x86_64 --target-os=android --cc='I:/soft/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/windows-x86_64/bin/x86_64-linux-android-gcc' --cross-prefix='I:/soft/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/windows-x86_64/bin/x86_64-linux-android-' --disable-stripping --nm='I:/soft/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/windows-x86_64/bin/x86_64-linux-android-nm' --sysroot='I:/soft/android-ndk-r14b/platforms/android-21/arch-x86_64' --enable-gpl --enable-shared --disable-static --enable-version3 --enable-pthreads --enable-small --disable-vda --disable-iconv --disable-encoders --enable-libx264 --enable-neon --enable-yasm --enable-libfdk_aac --enable-encoder=libx264 --enable-encoder=libfdk_aac --enable-encoder=mjpeg --enable-encoder=png --enable-nonfree --enable-muxers --enable-muxer=mov --enable-muxer=mp4 --enable-muxer=aac --enable-muxer=h264 --enable-muxer=avi --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=h264 --enable-decoder=mpeg4 --enable-decoder=mjpeg --enable-decoder=png --disable-demuxers --enable-demuxer=image2 --enable-demuxer=h264 --enable-demuxer=aac --enable-demuxer=avi --enable-demuxer=mpc --enable-demuxer=mov --disable-parsers --enable-parser=aac --enable-parser=ac3 --enable-parser=h264 --disable-protocols --enable-protocol=file --enable-zlib --enable-avfilter --disable-outdevs --disable-ffprobe --disable-ffplay --disable-ffmpeg --disable-ffserver --disable-debug --disable-ffprobe --disable-ffplay --disable-ffmpeg --disable-postproc --disable-avdevice --disable-symver --disable-stripping --extra-cflags='-Wall -pipe -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID  -II:/document/resourceCode/ffmpeg-3.2.5/mylib/x86_64/include -II:/document/resourceCode/ffmpeg-3.2.5/mylib/x86_64/include/fdk-aac  -O3 -DANDROID -march=x86-64 -msse4.2 -mpopcnt -m64 -mtune=intel' --extra-ldflags='-Wl,-LI:/document/resourceCode/ffmpeg-3.2.5/mylib/x86_64/lib'
prefix=./android/x86_64-vfp
...
ARCH=c
INTRINSICS=none
CC=I:/soft/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/windows-x86_64/bin/x86_64-linux-android-gcc
CXX=I:/soft/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/windows-x86_64/bin/x86_64-linux-android-g++
AS=I:/soft/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/windows-x86_64/bin/x86_64-linux-android-gcc
OBJCC=I:/soft/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/windows-x86_64/bin/x86_64-linux-android-gcc
LD=I:/soft/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/windows-x86_64/bin/x86_64-linux-android-gcc
DEPCC=I:/soft/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/windows-x86_64/bin/x86_64-linux-android-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=I:/soft/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/windows-x86_64/bin/x86_64-linux-android-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=I:/soft/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/windows-x86_64/bin/x86_64-linux-android-ar
ARFLAGS=rcD
AR_O=$@
RANLIB=I:/soft/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/windows-x86_64/bin/x86_64-linux-android-ranlib -D
STRIP=echo skipping strip
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=I:/soft/android-ndk-r14b/platforms/android-21/arch-x86_64 -isysroot I:/soft/android-ndk-r14b/platforms/android-21/arch-x86_64 -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -Wall -pipe -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -II:/document/resourceCode/ffmpeg-3.2.5/mylib/x86_64/include -II:/document/resourceCode/ffmpeg-3.2.5/mylib/x86_64/include/fdk-aac -O3 -DANDROID -march=x86-64 -msse4.2 -mpopcnt -m64 -mtune=intel -std=c99 -fomit-frame-pointer -fPIC -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++98
OBJCFLAGS=  
ASFLAGS=  -Wall -pipe -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -II:/document/resourceCode/ffmpeg-3.2.5/mylib/x86_64/include -II:/document/resourceCode/ffmpeg-3.2.5/mylib/x86_64/include/fdk-aac -O3 -DANDROID -march=x86-64 -msse4.2 -mpopcnt -m64 -mtune=intel -fPIC
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
WINDRES=I:/soft/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/windows-x86_64/bin/x86_64-linux-android-windres
DEPWINDRES=I:/soft/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/windows-x86_64/bin/x86_64-linux-android-gcc
DOXYGEN=doxygen
LDFLAGS= -Wl,-LI:/document/resourceCode/ffmpeg-3.2.5/mylib/x86_64/lib  --sysroot=I:/soft/android-ndk-r14b/platforms/android-21/arch-x86_64 -isysroot I:/soft/android-ndk-r14b/platforms/android-21/arch-x86_64 -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
